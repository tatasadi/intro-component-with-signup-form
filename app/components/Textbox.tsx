    ...
    <div className="mb-4">
      <div className="relative">
        <input
          ...
          className={` text-neutral-darkblue  w-full rounded-[0.3125rem] border px-[1.21rem] py-[0.94rem] text-[0.875rem] font-semibold leading-[1.625rem] tracking-[0.01563rem] placeholder:opacity-75 ${
            (errors?.length ?? 0) > 0
